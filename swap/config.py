...
PANCAKE_ABI = json.loads('[{"inputs":[{"internalType":"address","name":"_factory","type":"address"},'
...
ERC20_ABI = json.loads('[{"inputs":[{"internalType":"string","name":"name","type":"string"},{"internalType":"string",'
...
DEFAULT_SLIPPAGE: float  = 20 * 0.01
DEFAULT_GAS_PRICE: float = 5.1
DEFAULT_GAS_LIMIT: int = 700000